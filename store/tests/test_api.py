...
class BooksApiTestCase(APITestCase):
    def setUp(self):
        ...
        self.book_1 = Book.objects.create(
            name='Test Book1', price=23, author_name='Author 1', owner=self.user)
        self.book_2 = Book.objects.create(
            name='Test Book2', price=55, author_name='Author 5')
    ...
    def test_get_filter(self):
        ...
        serializer_data = BookSerializer(
            [self.book_2, self.book_3], many=True).data
    ...
    def test_update(self):
        ...
        self.book_1.refresh_from_db()  # Обновляем объект из базы данных
    ...
    def test_update_not_owner(self):
        ...
        self.assertEqual({'detail': ErrorDetail(
            string='You do not have permission to perform this action.', code='permission_denied')}, response.data)
